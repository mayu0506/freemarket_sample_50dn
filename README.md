...
|buyer_id|references|null: false, foreign_key: true,null: false, add_foreign_key :comments, :users, column: :buyer_id|
|seller_id|references|null: false, foreign_key: true,null: false, add_foreign_key :comments, :users, column: :seller_id|
