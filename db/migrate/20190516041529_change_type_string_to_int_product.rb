  ...
  def change
    reversible do |dir|
      change_table :products do |t|
        dir.up   { t.change :condition, :integer ,default: nil,null:false}
        dir.up   { t.change :who_to_pay, :integer ,default: nil,null:false}
        dir.up   { t.change :origin_of_delivery, :integer ,default: nil, null:false}
        dir.up   { t.change :deliverying_date, :integer ,default: nil ,null:false}
